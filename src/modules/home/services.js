  ...
  return (
    <main>
      <section className="mt-20 relative">
        <div>
          <Image
            className="w-[100%] services-height h-[250px] sm:h-[400px] md:h-[500px] lg:h-[610px]  xl:h-[650px] 2xl:h-[780px] relative"
            src={service_bg}
          ...
          <div className="services-shape-img  absolute top-[65px] md:top-[80px] lg:top-[100px] left-[30px] sm:left-[40px] md:left-[70px] lg:left-[80px] xl:left-[150px] w-[87%] sm:w-[80%]  flex justify-center">
            <Image
            ...
            <div>
              <div className="services-title-container absolute -top-[35%] sm:top-[8%] left-0 md:left-[0%] lg:left-[3%]  xl:left-[5%] 2xl:left-[10%] text-white">
                ...
                <h1 className=" text-[17px] sm:text-[23px] md:text-[28px] lg:text-[36px] xl:text-[42px] 2xl:text-[48px]  lg:leading-[62px] font-bold">Explore what services <br /> we’re offering</h1>
                <hr className="w-[30%] xl:w-[35%] mt-3" />
              </div>

              <div className="services-item1 absolute top-[60%] sm:top-[85%] md:top-[94%] ld:top-[97%] -left-[1%] sm:left-0 md:left-[3%] lg:left-[5%] xl:left-[9%] 2xl:left-[14%] text-white flex gap-1.5 sm:gap-3 items-center">
              ...
              <div className="services-item2 absolute top-[26%] sm:top-[58%] md:top-[67%] ld:top-[70%] left-[37%] sm:left-[38%] md:left-[39%] xl:left-[41%] 2xl:left-[43%] text-white flex gap-3 items-center">
              ...
              <div className="services-item3 absolute -top-[14%] sm:top-[15%] md:top-[23%] ld:top-[26%] right-[3%] sm:-right-[6%] md:right-[1.5%] xl:right-[5%] 2xl:right-[12%] text-white flex gap-3 items-center">
