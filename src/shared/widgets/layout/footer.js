...
import upwork_Logo from "../../../assets/images/logo/upwork.svg";
...
export default function footer() {
  ...
  const resourcesData = [
    ...
    { name: "Take a part", url: "/take-part" },
  ...
  const contactsUsData = [
    { name: "85 MM Hossain Road, Kushtia" },
    { name: "Khulna, Bangladesh - 7000" },
    { name: "community@ecoysoft.com", url: "mailto:community@ecoysoft.com" },
    { name: "support@ecoysoft.com", url: "mailto:support@ecoysoft.com" },
    { name: "01937270044", url: "tel:+8801937270044" },
  ];
    ...
    <footer>
      <section className="mt-32 bg-[#f8f9fb]">
        <div className="flex flex-col items-center gap-6 pt-20">
          ...
          <h3 className="text-[19px] sm:text-3xl font-medium">
        ...
        <div className="w-[90%] mx-auto grid-cols-2 sm:grid-cols-3 grid lg:grid-cols-4 xl:grid-cols-5 justify-center  mt-16">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4 text-[#696668]">
              {footersHomeData.map((footer) => (
                <Link href={footer?.url} key={footer.name}>
                  {footer.name}
                </Link>
              ))}
            </div>
          ...
          <div className="flex flex-col gap-6 ">
            ...
            <div className="flex flex-col gap-4 text-[#696668]">
              {UsersData.map((user) => (
                <Link href={user?.url} key={user.name}>
                  {user.name}
                </Link>
              ))}
            </div>
          ...
          <div className="flex flex-col gap-6 mt-12 lg:mt-0">
            ...
            <div className="flex flex-col gap-4 text-[#696668]">
              {resourcesData.map((resource) => (
                <Link href={resource?.url} key={resource.name}>
                  {resource.name}
                </Link>
              ))}
            </div>
          ...
          <div className="flex flex-col gap-6 mt-12 lg:mt-0">
            ...
            <div className="flex flex-col gap-4 text-[#696668]">
              {supportsData.map((support) => (
                <Link href={support?.url} key={support.name}>
                  {support.name}
                </Link>
              ))}
            </div>
          ...
          <div className="flex flex-col gap-6 mt-12 lg:mt-0">
            ...
            <div className="flex flex-col gap-4 text-[#696668]">
              {contactsUsData.map((contact) => (
                <Link
                  href={contact.url?.length > 0 ? contact.url : ""}
                  key={contact.name}
                >
                  {contact.name}
                </Link>
        ...
        <div>
          <div className="flex gap-4 justify-center ">
            <p className=" block sm:hidden mt-20 sm:text-[12px] md:text-[16px] hover:text-[#03a9f5] transition-all delay-300">
              Eco Home
            </p>
            <p className=" block sm:hidden mt-20 sm:text-[12px] md:text-[16px] hover:text-[#03a9f5] transition-all delay-300">
              Contact Us
          ...
          <div className="mt-6">
            <div className="flex justify-center gap-4 ">
              <p className=" hidden sm:block sm:text-[12px] md:text-[16px] hover:text-[#03a9f5] transition-all delay-300">
                Eco Home
              </p>
              <p className=" hidden sm:block sm:text-[12px] md:text-[16px] hover:text-[#03a9f5] transition-all delay-300">
                Contact Us
